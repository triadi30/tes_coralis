...
class Auth extends CI_Controller
{
    ...
    private function _login()
    {
        ...
        if ($user) {
            ...
            $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert"> Login Gagal! Email belum terdaftar! </div>');
            redirect('auth');
        }
    }
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($foto = '') {
                ...
                if (!$this->upload->do_upload('image')) {
                    ...
                    //prepare input data to database
                    $data = [
                    ...
                    $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert"> Berhasil mendaftar! Silahkan verifikasi akun melalui email </div>');
                    redirect('auth');
                }
            }
        }
